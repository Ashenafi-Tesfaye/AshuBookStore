...
import com.ashenafiAG.spring.demo.AshuBookStorewithSpring.repository.PaymentRepository;
...
public class PaymentService {
	...
	public void insertPayment(Long orderId, String transactionId) {
		Payment payment = new Payment();
		payment.setDateCreated(new Date());
		payment.setTransactionId(transactionId);
		payment.setOrderedId(orderId);
	...
	public Result<Transaction> processTransaction(BigDecimal totalCost, String paymentMethodNonce){
		TransactionRequest req = new TransactionRequest().amount(totalCost).paymentMethodToken(paymentMethodNonce)
